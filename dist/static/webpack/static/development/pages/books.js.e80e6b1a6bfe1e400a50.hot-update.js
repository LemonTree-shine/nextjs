...
/* harmony import */ var _static_editorMd_editormd_min_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../static/editorMd/editormd.min.js */ "./static/editorMd/editormd.min.js");
/* harmony import */ var _static_editorMd_editormd_min_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_static_editorMd_editormd_min_js__WEBPACK_IMPORTED_MODULE_6__);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Index, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", {
        id: "test-editormd"
      }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("textarea", null));
    }
  }, {
    key: "componentDidMount",
    value: function componentDidMount() {
      _static_editorMd_editormd_min_js__WEBPACK_IMPORTED_MODULE_6__("test-editormd", {
        width: "90%",
        height: 640,
...
!function (e) {
  "use strict";
   ...
   true && "object" == ( false ? undefined : (0, _typeof2.default)(exports)) && "object" == ( false ? undefined : (0, _typeof2.default)(module)) ? module.exports = e :  true ? __webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js") || false : undefined;
}(function () {
  "use strict";
  ...
  if ("undefined" != typeof e) {
    ...
    t.prototype = t.fn = {
      ...
      gotoLine: function gotoLine(t) {
        ...
        if (t = (0, _parseInt2.default)(t) - 1, t > r) return alert("Error: The line number range 1-" + r), this;
        o.setCursor({
          line: t,
          ch: 0
        });
      ...
      extend: function extend() {
        return "undefined" != typeof arguments[1] && ("function" == typeof arguments[1] && (arguments[1] = e.proxy(arguments[1], this)), this[arguments[0]] = arguments[1]), "object" == (0, _typeof2.default)(arguments[0]) && "undefined" == typeof arguments[0].length && e.extend(!0, this, arguments[0]), this;
      },
      ...
      config: function config(t, i) {
        var o = this.settings;
        return "object" == (0, _typeof2.default)(t) && (o = e.extend(!0, o, t)), "string" == typeof t && (o[t] = i), this.settings = o, this.recreate(), this;
      },
      on: function on(t, i) {
        var o = this.settings;
      ...
      executePlugin: function executePlugin(i, o) {
        var r = this,
            n = this.cm,
            a = this.settings;
        return o = a.pluginPath + o,  true ? "undefined" == typeof this[i] ? (alert("Error: " + i + " plugin is not found, you are not load this plugin."), this) : (this[i](n), this) : (undefined);
      },
      ...
      t.css({
        top: (e(window).height() - t.height()) / 2 + "px",
        left: (e(window).width() - t.width()) / 2 + "px"
      }), o.dialogShowMask && i.children("." + this.classPrefix + "mask").css("z-index", (0, _parseInt2.default)(t.css("z-index")) - 1).show();
    }, t.toolbarHandlers = {
      undo: function undo() {
        this.cm.undo();
      },
    ...
    return t.firstUpperCase = t.ucfirst = a, t.urls = {
      ...
      }), "object" == (0, _typeof2.default)(i.buttons)) {
      ...
      if ("" !== i.title && i.drag) {
        ...
        i.mask || k.bind(c("click", "touchend"), function () {
          ...
          e = e || window.event, w = e.clientX - (0, _parseInt2.default)(d[0].style.left), v = e.clientY - (0, _parseInt2.default)(d[0].style.top), document.onmousemove = y;
        });
        ...
        var b = function b(e) {
          ...
          var i,
              o,
              r = (0, _parseInt2.default)(d[0].style.left),
              n = (0, _parseInt2.default)(d[0].style.top);
...
//# sourceMappingURL=books.js.e80e6b1a6bfe1e400a50.hot-update.js.map